            ...
            <div className="h-96 w-80 flex flex-col items-center text-center shadow-sm shadow-gray-700 bg-gray-900 rounded-2xl justify-evenly">
                ...
                <div className="h-32 w-full px-4 flex flex-col items-start justify-around">
                    ...
                    <div className="flex items-center justify-evenly w-full">
                        <button
                            className="bg-blue-400 py-2 text-sm px-2 text-white font-semibold rounded-lg w-28 hover:bg-blue-600 transition duration-200"
                            onClick={() => navigate('/update-profile')}
                        >
                            Update Profile
                        </button>
                        <button
                            className="bg-transparent border border-red-400 py-2 text-sm px-2 font-semibold text-red-400 rounded-lg w-28 hover:bg-red-500 hover:text-white transition duration-200"
                            onClick={logout}
                        >
                            Logout
                        </button>
